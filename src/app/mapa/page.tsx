    ...
    <main className="relative w-full min-h-screen bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-[rgba(25,25,35,1)] via-[#0A0A0F] to-[#050508] overflow-x-hidden">
      ...
      <section className="relative z-20 bg-[#050508] border-t border-gold/20 py-24 px-6 md:px-12 lg:px-24 shadow-[0_-10px_40px_rgba(0,0,0,0.5)]">
        <div className="max-w-4xl mx-auto">
          ...
          >
            <h2 className="text-3xl md:text-5xl font-display text-transparent bg-clip-text bg-gradient-to-r from-gold via-gold-light to-gold tracking-widest uppercase mb-4">
              ...
              <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                ...
                <ul className="space-y-5">
                  <li className="flex items-start gap-4">
                    <span className="w-5 h-5 flex-shrink-0 rounded-full bg-gold border border-white/30 mt-1 flex items-center justify-center"></span>
                    <div>
                  ...
                  <li className="flex items-start gap-4">
                    <span className="w-5 h-5 flex-shrink-0 bg-gold border border-white/30 mt-1 flex items-center justify-center"></span>
                    <div>
                  ...
                  <li className="flex items-start gap-4">
                    <span className="w-0 h-0 border-l-[10px] border-l-transparent border-r-[10px] border-r-transparent border-b-[18px] border-b-gold mt-1 flex-shrink-0"></span>
                    <div>
                  ...
                  <li className="flex items-start gap-4">
                    <svg className="w-5 h-5 text-red-400 flex-shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4 4l16 16m-16 0l16-16"></path></svg>
                    <div>
